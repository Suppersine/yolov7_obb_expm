...
class ComputeLoss:
    ...
    def __init__(self, model, autobalance=False):
        ...
        BCEtheta = nn.BCEWithLogitsLoss(pos_weight=torch.tensor([h['theta_pw']], device=device)) # angularly-related variable added
        ...
        if g > 0:
            ...
            BCEtheta = FocalLoss(BCEtheta, g) # angularly-related variable added
        ...
        self.BCEtheta = BCEtheta # angularly-related variable added
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        ltheta = torch.zeros(1, device=device) # angularly-related variable added
        #tcls, tbox, indices, anchors = self.build_targets(p, targets)  # targets
        tcls, tbox, indices, anchors, tgaussian_theta = self.build_targets(p, targets)  # targets, angularly-related variable added
